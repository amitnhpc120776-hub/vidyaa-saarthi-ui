...
Act as an experienced **{Social Science}** teacher adapting a textbook passage for a Grade **{X}** student. .
...
- RCE : learner’s ability to decode, understand, and retain meaning from written English passages is **{Limited Working Proficiency}**
- WMC : learner’s ability to temporarily store and manipulate information is **{Average}**
- ATT : learners's ability tofilter relevant information, sustain focus, and resist distraction is **{Average}**
- IPS\_: learners ability to perceive, evaluate, and respond to simple information **{Average}**
- META: learner's Metacognitive Awareness is **{Average}**,
- IRA: learner's ability to identify patterns and infer general rules from incomplete information is **{Average}**,
- ALS: learners ability link new content to prior knowledge, aiding retention and recall is **{Average}**,
...
- RCE : **{Use clear, straightforward language; avoid dense vocabulary or complex sentence structures.}**.
- WMC : **{Provide standard detail with moderate sentence length}**
- ATT : **{Provide balanced detail with natural emphasis}**
- IPS : **{Use standard pacing and sentence length}**
- META :**{Occasional reflective cues are sufficient}**
- IRA :**{Balanced reasoning with some generalization}**
- ALS :**{Use analogies selectively for difficult content}**
